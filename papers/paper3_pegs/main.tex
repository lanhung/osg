...
Open source-family extraction currently retains two geodetic recurrence
families from Zhao and Niu~\cite{Zhao2024,Zhao2025} and 19 PMEL-based
scenario families from Liu et al.~\cite{Liu2023}. The latter provide
magnitude-specific geometry, slip and five-location modelled arrival ranges.
They remain outside the PEGS simulator library because rise time and rupture
velocity are not reported and the extracted arrival threshold definition is
not explicit.
...
Liu et al.~\cite{Liu2023Manila} provide a complementary PMEL/SIFT-based set of
