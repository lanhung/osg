...
Van Camp et al. (2020), DOI [10.1093/gji/ggaa359](https://doi.org/10.1093/gji/ggaa359), applied a three-channel correlation method to quiet, co-located iGrav records to estimate incoherent noise containing self-noise. The text reports average levels near -180 dB relative to `1 (m s^-2)^2 Hz^-1` from `10^-3` to `10^-1 Hz` for quiet J9 instruments. This converts to PSD `10^-18 (m s^-2)^2 Hz^-1` and ASD `10^-9 m s^-2 Hz^-1/2`.
...
Ménoret et al. (2018), DOI [10.1038/s41598-018-30608-1](https://doi.org/10.1038/s41598-018-30608-1), report short-term sensitivities of 750 `nm s^-2 Hz^-1/2` for AQG-A01 and 450 `nm s^-2 Hz^-1/2` for FG5#228. They report a 36 s effective FG5 sampling interval and AQG response decrease above about 0.05 Hz due to the servo loop. The study also reports AQG long-term stability below 10 `nm s^-2`, which is a different statistic and is not converted into ASD.
