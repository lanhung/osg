...
\section{Results}
\TyphoonPending{No SG event data are authorized in the repository. Do not insert
synthetic foundation results as event detections.}
...
\section{Limitations}
\TyphoonPending{Update after data authorization, product audit, elastic benchmark,
