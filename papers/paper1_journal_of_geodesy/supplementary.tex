...
\resizebox{\textwidth}{!}{\input{generated/process_parameters.tex}}
\end{table}
...
\resizebox{\textwidth}{!}{\input{generated/record_registry.tex}}
\end{table}

\begin{table}[ht]
\centering
\caption{Native-grid lower-frequency requirements. These values are retained
as the historical P1-E008 result and are superseded for interpretation by the
P1-E011 convergence audit in Table~\ref{tab:s4-convergence}.}
\label{tab:s3-frequency}
\resizebox{\textwidth}{!}{\input{generated/frequency_requirements.tex}}
\end{table}

\begin{table}[ht]
\centering
\caption{P1-E011 dense-grid and record-window audit at 90\% unweighted
finite-record spectral-energy coverage. The window-limited ranges are scenario
diagnostics rather than process constants.}
\label{tab:s4-convergence}
\resizebox{\textwidth}{!}{\input{generated/temporal_spectral_convergence.tex}}
\end{table}
...
\label{tab:s5-instruments}
\resizebox{\textwidth}{!}{\input{generated/instrument_evidence.tex}}
\end{table}
